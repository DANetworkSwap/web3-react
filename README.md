...
| `@daswap/injected-connector`      | [![npm version](https://img.shields.io/npm/v/@daswap/injected-connector/latest.svg)](https://www.npmjs.com/package/@daswap/injected-connector/v/latest)           | [![minzip](https://img.shields.io/bundlephobia/minzip/@daswap/injected-connector/latest.svg)](https://bundlephobia.com/result?p=@daswap/injected-connector@latest)           | [Injected](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1193.md) Connector |
| _Remote API_                          |
